...
goog.exportSymbol('proto.qmq.Header', null, global);
...
goog.exportSymbol('proto.qmq.RedisStreamContext', null, global);
goog.exportSymbol('proto.qmq.SchemaData', null, global);
goog.exportSymbol('proto.qmq.String', null, global);
goog.exportSymbol('proto.qmq.TextToSpeechRequest', null, global);
 ...
 * @constructor
 */
proto.qmq.Header = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.qmq.Header, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.qmq.Header.displayName = 'proto.qmq.Header';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.qmq.SchemaData = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.qmq.SchemaData, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.qmq.SchemaData.displayName = 'proto.qmq.SchemaData';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.qmq.RedisStreamContext = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.qmq.RedisStreamContext, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.qmq.RedisStreamContext.displayName = 'proto.qmq.RedisStreamContext';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.qmq.TextToSpeechRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.qmq.TextToSpeechRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.qmq.TextToSpeechRequest.displayName = 'proto.qmq.TextToSpeechRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.qmq.Header.prototype.toObject = function(opt_includeInstance) {
  return proto.qmq.Header.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.qmq.Header} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.qmq.Header}
 */
proto.qmq.Header.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.qmq.Header;
  return proto.qmq.Header.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.qmq.Header} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.qmq.Header}
 */
proto.qmq.Header.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.qmq.Header.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.qmq.Header.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.qmq.Header} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.qmq.Header.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.qmq.Header.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.qmq.Header.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.qmq.Header.prototype.getSubject = function() {
 ...
 * @return {!proto.qmq.Header} returns this
 */
proto.qmq.Header.prototype.setSubject = function(value) {
...
proto.qmq.Message.toObject = function(includeInstance, msg) {
  var f, obj = {
    header: (f = msg.getHeader()) && proto.qmq.Header.toObject(includeInstance, f),
...
proto.qmq.Message.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.qmq.Header;
      reader.readMessage(value,proto.qmq.Header.deserializeBinaryFromReader);
      msg.setHeader(value);
      break;
    case 2:
...
proto.qmq.Message.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.qmq.Header.serializeBinaryToWriter
    );
  }
 ...
 * @return {?proto.qmq.Header}
 */
proto.qmq.Message.prototype.getHeader = function() {
  return /** @type{?proto.qmq.Header} */ (
    jspb.Message.getWrapperField(this, proto.qmq.Header, 1));
};


/**
 * @param {?proto.qmq.Header|undefined} value
 * @return {!proto.qmq.Message} returns this
*/
proto.qmq.Message.prototype.setHeader = function(value) {
 ...
 * @return {!proto.qmq.Message} returns this
 */
proto.qmq.Message.prototype.clearHeader = function() {
 ...
 * @return {boolean}
 */
proto.qmq.Message.prototype.hasHeader = function() {
 ...
 * @return {!Object}
 */
proto.qmq.SchemaData.prototype.toObject = function(opt_includeInstance) {
  return proto.qmq.SchemaData.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.qmq.SchemaData} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.qmq.SchemaData.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.qmq.SchemaData}
 */
proto.qmq.SchemaData.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.qmq.SchemaData;
  return proto.qmq.SchemaData.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.qmq.SchemaData} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.qmq.SchemaData}
 */
proto.qmq.SchemaData.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.qmq.SchemaData.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.qmq.SchemaData.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.qmq.SchemaData} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.qmq.SchemaData.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getData();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.google.protobuf.Any}
 */
proto.qmq.SchemaData.prototype.getData = function() {
  return /** @type{?proto.google.protobuf.Any} */ (
...
/**
 * @param {?proto.google.protobuf.Any|undefined} value
 * @return {!proto.qmq.SchemaData} returns this
*/
proto.qmq.SchemaData.prototype.setData = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.qmq.SchemaData} returns this
 */
proto.qmq.SchemaData.prototype.clearData = function() {
 ...
 * @return {boolean}
 */
proto.qmq.SchemaData.prototype.hasData = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {string}
 */
proto.qmq.SchemaData.prototype.getWriter = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.qmq.SchemaData} returns this
 */
proto.qmq.SchemaData.prototype.setWriter = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.qmq.SchemaData.prototype.getWritetime = function() {
 ...
 * @return {!proto.qmq.SchemaData} returns this
*/
proto.qmq.SchemaData.prototype.setWritetime = function(value) {
 ...
 * @return {!proto.qmq.SchemaData} returns this
 */
proto.qmq.SchemaData.prototype.clearWritetime = function() {
 ...
 * @return {boolean}
 */
proto.qmq.SchemaData.prototype.hasWritetime = function() {
 ...
 * @return {!Object}
 */
proto.qmq.RedisStreamContext.prototype.toObject = function(opt_includeInstance) {
  return proto.qmq.RedisStreamContext.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.qmq.RedisStreamContext} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.qmq.RedisStreamContext.toObject = function(includeInstance, msg) {
  var f, obj = {
    lastConsumedId: jspb.Message.getFieldWithDefault(msg, 1, ""),
    lastProducedId: jspb.Message.getFieldWithDefault(msg, 2, ""),
    totalConsumed: jspb.Message.getFieldWithDefault(msg, 3, 0),
    totalProduced: jspb.Message.getFieldWithDefault(msg, 4, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.qmq.RedisStreamContext}
 */
proto.qmq.RedisStreamContext.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.qmq.RedisStreamContext;
  return proto.qmq.RedisStreamContext.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.qmq.RedisStreamContext} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.qmq.RedisStreamContext}
 */
proto.qmq.RedisStreamContext.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      var value = /** @type {string} */ (reader.readString());
      msg.setLastConsumedId(value);
      break;
    case 2:
      var value = /** @type {string} */ (reader.readString());
      msg.setLastProducedId(value);
      break;
    case 3:
      var value = /** @type {number} */ (reader.readInt64());
 ...
 * @return {!Uint8Array}
 */
proto.qmq.RedisStreamContext.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.qmq.RedisStreamContext.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.qmq.RedisStreamContext} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.qmq.RedisStreamContext.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.qmq.RedisStreamContext.prototype.getLastConsumedId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.qmq.RedisStreamContext} returns this
 */
proto.qmq.RedisStreamContext.prototype.setLastConsumedId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.qmq.RedisStreamContext.prototype.getLastProducedId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.qmq.RedisStreamContext} returns this
 */
proto.qmq.RedisStreamContext.prototype.setLastProducedId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.qmq.RedisStreamContext.prototype.getTotalConsumed = function() {
 ...
 * @return {!proto.qmq.RedisStreamContext} returns this
 */
proto.qmq.RedisStreamContext.prototype.setTotalConsumed = function(value) {
 ...
 * @return {number}
 */
proto.qmq.RedisStreamContext.prototype.getTotalProduced = function() {
 ...
 * @return {!proto.qmq.RedisStreamContext} returns this
 */
proto.qmq.RedisStreamContext.prototype.setTotalProduced = function(value) {
 ...
 * @return {!Object}
 */
proto.qmq.TextToSpeechRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.qmq.TextToSpeechRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.qmq.TextToSpeechRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.qmq.TextToSpeechRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.qmq.TextToSpeechRequest}
 */
proto.qmq.TextToSpeechRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.qmq.TextToSpeechRequest;
  return proto.qmq.TextToSpeechRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.qmq.TextToSpeechRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.qmq.TextToSpeechRequest}
 */
proto.qmq.TextToSpeechRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.qmq.TextToSpeechRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.qmq.TextToSpeechRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.qmq.TextToSpeechRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.qmq.TextToSpeechRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getText();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.qmq.TextToSpeechRequest.prototype.getText = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.qmq.TextToSpeechRequest} returns this
 */
proto.qmq.TextToSpeechRequest.prototype.setText = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
...
proto.qmq.MqttMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    duplicate: jspb.Message.getBooleanFieldWithDefault(msg, 6, false)
  };
