...
func file_src_protobufs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_src_protobufs_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
		...
		file_src_protobufs_proto_msgTypes[37].Exporter = func(v interface{}, i int) interface{} {
		...
		file_src_protobufs_proto_msgTypes[38].Exporter = func(v interface{}, i int) interface{} {
		...
		file_src_protobufs_proto_msgTypes[39].Exporter = func(v interface{}, i int) interface{} {
