...
func (LogMessage_LogLevelEnum) EnumDescriptor() ([]byte, []int) {
	return file_src_protobufs_proto_rawDescGZIP(), []int{31, 0}
}
...
var file_src_protobufs_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x01, 0x52, 0x03, 0x72, 0x61, 0x77, 0x22, 0x18, 0x0a, 0x04, 0x42, 0x6f, 0x6f,
	0x6c, 0x12, 0x10, 0x0a, 0x03, 0x72, 0x61, 0x77, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x03,
	0x72, 0x61, 0x77, 0x22, 0x21, 0x0a, 0x0f, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x52, 0x65, 0x66,
	0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x97, 0x02, 0x0a, 0x0a, 0x4c, 0x6f, 0x67, 0x4d, 0x65,
...
var file_src_protobufs_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
var file_src_protobufs_proto_goTypes = []interface{}{
	...
	(*Int)(nil),                                      // 35: qmq.Int
	(*String)(nil),                                   // 36: qmq.String
	(*Timestamp)(nil),                                // 37: qmq.Timestamp
	(*Float)(nil),                                    // 38: qmq.Float
	(*Bool)(nil),                                     // 39: qmq.Bool
	(*EntityReference)(nil),                          // 40: qmq.EntityReference
	(*LogMessage)(nil),                               // 41: qmq.LogMessage
	(*GarageDoorState)(nil),                          // 42: qmq.GarageDoorState
	(*ConnectionState)(nil),                          // 43: qmq.ConnectionState
	(*timestamppb.Timestamp)(nil),                    // 44: google.protobuf.Timestamp
	(*anypb.Any)(nil),                                // 45: google.protobuf.Any
}
var file_src_protobufs_proto_depIdxs = []int32{
	44, // 0: qmq.WebHeader.timestamp:type_name -> google.protobuf.Timestamp
	10, // 1: qmq.WebMessage.header:type_name -> qmq.WebHeader
	45, // 2: qmq.WebMessage.payload:type_name -> google.protobuf.Any
	...
	40, // 14: qmq.DatabaseEntity.parent:type_name -> qmq.EntityReference
	40, // 15: qmq.DatabaseEntity.children:type_name -> qmq.EntityReference
	45, // 16: qmq.DatabaseField.value:type_name -> google.protobuf.Any
	44, // 17: qmq.DatabaseField.writeTime:type_name -> google.protobuf.Timestamp
	...
	45, // 21: qmq.DatabaseRequest.value:type_name -> google.protobuf.Any
	37, // 22: qmq.DatabaseRequest.writeTime:type_name -> qmq.Timestamp
	36, // 23: qmq.DatabaseRequest.writerId:type_name -> qmq.String
	44, // 24: qmq.Timestamp.raw:type_name -> google.protobuf.Timestamp
	7,  // 25: qmq.LogMessage.level:type_name -> qmq.LogMessage.LogLevelEnum
	44, // 26: qmq.LogMessage.timestamp:type_name -> google.protobuf.Timestamp
	8,  // 27: qmq.GarageDoorState.raw:type_name -> qmq.GarageDoorState.GarageDoorStateEnum
	9,  // 28: qmq.ConnectionState.raw:type_name -> qmq.ConnectionState.ConnectionStateEnum
