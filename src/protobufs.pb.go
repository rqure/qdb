...
type QMQMqttMessage struct {
	...
	Deplicate bool   `protobuf:"varint,6,opt,name=deplicate,proto3" json:"deplicate,omitempty"`
}
...
func (x *QMQMqttMessage) GetDeplicate() bool {
	if x != nil {
		return x.Deplicate
	}
	return false
...
var file_src_protobufs_proto_rawDesc = []byte{
	...
	0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09,
	0x64, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x65, 0x2a, 0xaa, 0x01, 0x0a, 0x0f, 0x51, 0x4d,
...
var file_src_protobufs_proto_goTypes = []interface{}{
	...
	(*QMQData)(nil),               // 1: qmq.QMQData
	(*QMQInt)(nil),                // 2: qmq.QMQInt
	(*QMQString)(nil),             // 3: qmq.QMQString
	(*QMQTimestamp)(nil),          // 4: qmq.QMQTimestamp
	(*QMQFloat)(nil),              // 5: qmq.QMQFloat
	(*QMQBool)(nil),               // 6: qmq.QMQBool
	(*QMQLog)(nil),                // 7: qmq.QMQLog
	(*QMQStreamContext)(nil),      // 8: qmq.QMQStreamContext
	(*QMQPrayer)(nil),             // 9: qmq.QMQPrayer
	(*QMQAudioRequest)(nil),       // 10: qmq.QMQAudioRequest
	(*QMQMqttMessage)(nil),        // 11: qmq.QMQMqttMessage
	(*anypb.Any)(nil),             // 12: google.protobuf.Any
	(*timestamppb.Timestamp)(nil), // 13: google.protobuf.Timestamp
}
var file_src_protobufs_proto_depIdxs = []int32{
	12, // 0: qmq.QMQData.data:type_name -> google.protobuf.Any
	13, // 1: qmq.QMQData.writetime:type_name -> google.protobuf.Timestamp
	13, // 2: qmq.QMQTimestamp.value:type_name -> google.protobuf.Timestamp
	0,  // 3: qmq.QMQLog.level:type_name -> qmq.QMQLogLevelEnum
	13, // 4: qmq.QMQLog.timestamp:type_name -> google.protobuf.Timestamp
	13, // 5: qmq.QMQPrayer.time:type_name -> google.protobuf.Timestamp
